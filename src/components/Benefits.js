                ...
                {this.props.userView === true ? (
                    ...
                    (
                        <React.Fragment>
                            ...
                            <BenefitsTileReverse img={images.host2} title="Work on your own timeline" desc='Just want to share a space for the summer? Have a free room year-round? With SpaceFaster, you can list your space on your time and set your own hours. If you want to stop, you can easily remove your listing, no strings attached.' />
                            <BenefitsTile img={images.host3} title="Meet your neighbor" desc='SpaceFaster set out to build stronger bonds between residents of a neighborhood. These relationships are lost in today’s world, but we hope to connect neighbors, create friendships, and strengthen communities.' />
                        </React.Fragment>
                    )
                }
            </div>
